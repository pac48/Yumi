...
class EgmClock : public ::google::protobuf::Message {
 public:
  EgmClock();
  virtual ~EgmClock();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static EgmClock* default_instance_;
};
// -------------------------------------------------------------------
...
class EgmPlanned : public ::google::protobuf::Message {
 public:
  ...
  inline const ::abb::egm::EgmClock& time() const;
  inline ::abb::egm::EgmClock* mutable_time();
  inline ::abb::egm::EgmClock* release_time();
  inline void set_allocated_time(::abb::egm::EgmClock* time);
...
class EgmMeasuredForce : public ::google::protobuf::Message {
 public:
  EgmMeasuredForce();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static EgmMeasuredForce* default_instance_;
};
// -------------------------------------------------------------------
...
class EgmRobot : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_measuredforce() const;
  inline void clear_measuredforce();
  static const int kMeasuredForceFieldNumber = 9;
  inline const ::abb::egm::EgmMeasuredForce& measuredforce() const;
  inline ::abb::egm::EgmMeasuredForce* mutable_measuredforce();
  inline ::abb::egm::EgmMeasuredForce* release_measuredforce();
  inline void set_allocated_measuredforce(::abb::egm::EgmMeasuredForce* measuredforce);
 ...
 private:
  ...
  inline void set_has_measuredforce();
  inline void clear_has_measuredforce();
...
inline ::abb::egm::EgmClock* EgmPlanned::mutable_time() {
  set_has_time();
  if (time_ == NULL) time_ = new ::abb::egm::EgmClock;
...
inline const ::abb::egm::EgmMeasuredForce& EgmRobot::measuredforce() const {
  ...
  return measuredforce_ != NULL ? *measuredforce_ : *default_instance_->measuredforce_;
}
inline ::abb::egm::EgmMeasuredForce* EgmRobot::mutable_measuredforce() {
  set_has_measuredforce();
  if (measuredforce_ == NULL) measuredforce_ = new ::abb::egm::EgmMeasuredForce;
