...
const ::google::protobuf::Descriptor* EgmClock_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  EgmClock_reflection_ = NULL;
...
const ::google::protobuf::Descriptor* EgmMeasuredForce_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  EgmMeasuredForce_reflection_ = NULL;
...
void protobuf_AssignDesc_egm_2eproto() {
  ...
  EgmEuler_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmEuler));
  EgmClock_descriptor_ = file->message_type(4);
  static const int EgmClock_offsets_[2] = {
  ...
  EgmClock_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      EgmClock_descriptor_,
      EgmClock::default_instance_,
      EgmClock_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EgmClock, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EgmClock, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmClock));
  EgmPose_descriptor_ = file->message_type(5);
  ...
  EgmPose_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmPose));
  EgmCartesianSpeed_descriptor_ = file->message_type(6);
  ...
  EgmJoints_descriptor_ = file->message_type(7);
  ...
  EgmJoints_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmJoints));
  EgmExternalJoints_descriptor_ = file->message_type(8);
  ...
  EgmPlanned_descriptor_ = file->message_type(9);
  static const int EgmPlanned_offsets_[4] = {
  ...
  EgmPlanned_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmPlanned));
  EgmSpeedRef_descriptor_ = file->message_type(10);
  ...
  EgmSpeedRef_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmSpeedRef));
  EgmPathCorr_descriptor_ = file->message_type(11);
  ...
  EgmPathCorr_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmPathCorr));
  EgmFeedBack_descriptor_ = file->message_type(12);
  static const int EgmFeedBack_offsets_[4] = {
  ...
  EgmFeedBack_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmFeedBack));
  EgmMotorState_descriptor_ = file->message_type(13);
  ...
  EgmMCIState_descriptor_ = file->message_type(14);
  ...
  EgmRapidCtrlExecState_descriptor_ = file->message_type(15);
  ...
  EgmTestSignals_descriptor_ = file->message_type(16);
  ...
  EgmMeasuredForce_descriptor_ = file->message_type(17);
  static const int EgmMeasuredForce_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EgmMeasuredForce, force_),
  };
  EgmMeasuredForce_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      EgmMeasuredForce_descriptor_,
      EgmMeasuredForce::default_instance_,
      EgmMeasuredForce_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EgmMeasuredForce, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EgmMeasuredForce, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmMeasuredForce));
  EgmRobot_descriptor_ = file->message_type(18);
  static const int EgmRobot_offsets_[9] = {
  ...
  EgmRobot_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmRobot));
  EgmSensor_descriptor_ = file->message_type(19);
  ...
  EgmSensor_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(EgmSensor));
  EgmSensorPathCorr_descriptor_ = file->message_type(20);
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    EgmClock_descriptor_, &EgmClock::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    EgmMeasuredForce_descriptor_, &EgmMeasuredForce::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_egm_2eproto() {
  ...
  delete EgmClock::default_instance_;
  delete EgmClock_reflection_;
  ...
  delete EgmMeasuredForce::default_instance_;
  delete EgmMeasuredForce_reflection_;
...
void protobuf_AddDesc_egm_2eproto() {
  ...
  EgmClock::default_instance_ = new EgmClock();
  ...
  EgmMeasuredForce::default_instance_ = new EgmMeasuredForce();
  ...
  EgmClock::default_instance_->InitAsDefaultInstance();
  ...
  EgmMeasuredForce::default_instance_->InitAsDefaultInstance();
...
EgmClock* EgmClock::default_instance_ = NULL;

EgmClock* EgmClock::New() const {
  return new EgmClock;
}

void EgmClock::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<EgmClock*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
::google::protobuf::uint8* EgmClock::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void EgmClock::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const EgmClock* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const EgmClock*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
::google::protobuf::Metadata EgmClock::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = EgmClock_descriptor_;
  metadata.reflection = EgmClock_reflection_;
  return metadata;
}
...
void EgmPlanned::InitAsDefaultInstance() {
  ...
  time_ = const_cast< ::abb::egm::EgmClock*>(&::abb::egm::EgmClock::default_instance());
}
...
const ::google::protobuf::Descriptor* EgmMeasuredForce::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return EgmMeasuredForce_descriptor_;
}
...
EgmMeasuredForce* EgmMeasuredForce::default_instance_ = NULL;

EgmMeasuredForce* EgmMeasuredForce::New() const {
  return new EgmMeasuredForce;
}
...
::google::protobuf::uint8* EgmMeasuredForce::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
int EgmMeasuredForce::ByteSize() const {
  int total_size = 0;
...
void EgmMeasuredForce::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const EgmMeasuredForce* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const EgmMeasuredForce*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
::google::protobuf::Metadata EgmMeasuredForce::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = EgmMeasuredForce_descriptor_;
  metadata.reflection = EgmMeasuredForce_reflection_;
  return metadata;
}
...
void EgmRobot::InitAsDefaultInstance() {
  ...
  measuredforce_ = const_cast< ::abb::egm::EgmMeasuredForce*>(&::abb::egm::EgmMeasuredForce::default_instance());
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_measuredForce;
        break;
      }
