...
"""autogenerated by genpy from dynamics/getCRequest.msg. Do not edit."""
import sys
...
class getCRequest(genpy.Message):
  _md5sum = "6d83ce00ac0a3fe658fc7a98493c70b4"
  _type = "dynamics/getCRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(getCRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dynamics/getCResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class getCResponse(genpy.Message):
  _md5sum = "8fc6bee779dde8defe0f7a3be3a232ff"
  _type = "dynamics/getCResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(getCResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.c is None:
        self.c = []
    else:
...
class getC(object):
  _type          = 'dynamics/getC'
  _md5sum = 'bf7b2a43e3810114058d53b94861aa7b'
  _request_class  = getCRequest
  _response_class = getCResponse
