...
namespace yumi_hardware {
  ...
  protected:
    ...
    abb::egm::wrapper::Input input_r_;
    abb::egm::wrapper::Joints initial_velocity_r_;
    abb::egm::wrapper::Joints initial_velocity2_r_;
    abb::egm::wrapper::Output output_r_;
    abb::egm::wrapper::Input input_l_;
    abb::egm::wrapper::Joints initial_velocity_l_;
    abb::egm::wrapper::Joints initial_velocity2_l_;
    abb::egm::wrapper::Output output_l_;
